...
int main() {
    ...
    for (int platformIndex = 0; platformIndex < platformsCount; ++platformIndex) {
        ...
        std::cout << "    Number of devices for platform: " << devicesCount << std::endl;
        ...
        for (int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex) {
            ...
            // memory
            cl_ulong deviceMemorySize = 0, deviceMemory = 0;
            ...
            std::cout << "        Device memory: " << (deviceMemory / 1024 / 1024) << " MBit"<< std::endl;

            // driver version
            size_t deviceDriverNameSize = 0;
            OCL_SAFE_CALL(clGetDeviceInfo(device, CL_DRIVER_VERSION, 0, nullptr, &deviceDriverNameSize));

            std::vector<unsigned char> deviceDriverName(deviceDriverNameSize, 0);
