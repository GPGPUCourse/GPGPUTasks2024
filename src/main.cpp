...
int main() {
    ...
    for (int platformIndex = 0; platformIndex < platformsCount; ++platformIndex) {
        ...
        for (int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex) {
            ...
            cl_device_id device = platformDevices.at(deviceIndex);
            ...
            if (deviceType == CL_DEVICE_TYPE_CPU) {
                ...
                std::cout << "        Type: Something strange" << std::endl;
            }
            ...
            std::cout << "        Global cache memory size: " << globalMemCacheSize / 1024 << "KB" << std::endl;
        }
    }
