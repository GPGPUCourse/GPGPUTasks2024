...
int main() {
    ...
    for (int platformIndex = 0; platformIndex < platformsCount; ++platformIndex) {
        ...
        for (int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex) {
            ...
            std::string deviceTypeStr = "unknown";
            ...
            cl_ulong glMemSize = 0;
            OCL_SAFE_CALL(clGetDeviceInfo(device, CL_DEVICE_GLOBAL_MEM_SIZE, sizeof glMemSize, &glMemSize, nullptr));
            std::cout << "      Global memory: " << (glMemSize >> 20) << " mb" << std::endl;

            cl_ulong maxFreq = 0;
            OCL_SAFE_CALL(clGetDeviceInfo(device, CL_DEVICE_MAX_CLOCK_FREQUENCY, sizeof maxFreq, &maxFreq, nullptr));
            std::cout << "      Max clock frequency: " << maxFreq << " mhz" << std::endl;

            cl_ulong computeUnits = 0;
