...
__kernel void aplusb(__global float *as_gpu, __global float *bs_gpu, __global float *cs_gpu, unsigned int n) {
    ...
    // cs_gpu[gid] = as_gpu[gid] + 1; ошибка попалась
    cs_gpu[gid] = as_gpu[gid] + bs_gpu[gid];
}
