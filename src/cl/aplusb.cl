...
__kernel void aplusb(__global float* as, __global float* bs,
                     __global float* cs, unsigned int size) {
    ...
    // либо сделать return в кернеле до обращения к данным в тех WorkItems, где get_global_id(0) выходит за границы данных
